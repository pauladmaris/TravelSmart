            ...
            <form action="" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="input-group">
						<h3>Location: </h3>
						<input type="text" value="<?php echo $row1['location']; ?>" name="location" id="location" required autocomplete="off" style="width:100%; font-family:cursive">
					</div>
				</div>
				<div class="row">
					<div class="input-group">
				...
				<div class="row">
					...
					<h3>Choose another image: </h3>
                        ...
                        <input type="hidden" name="user-username" value="<?php echo $row1['username']; ?>">
                    </div>
                </div>
				<br />
				...
				<div class="input-group button">
                	<button class="btn" type="submit" name="editAdmin" id="save">Save & Post</button>
				</div>
